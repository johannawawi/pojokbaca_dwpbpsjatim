        ...
        <div class="row d-flex flex-wrap justify-content-center">
            ...
            @forelse ($buku as $item)
                <div class="col-auto my-2" style="width:18rem;">
                    <div class="card mx-2 my-2 d-flex flex-column justify-content-between" style="height:30rem;">
                        @if ($item->gambar != null)
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            <div class="detai-buku">
                                <h5 class="card-title text-primary" style="
                                    font-size:1rem;
                                    font-weight:bold;
                                ...
                                ">
                                    ...
                                    <a href="#" style="
                                        ...
                                        text-overflow:ellipsis;
                                        white-space:nowrap;
                                        max-width:calc(100% - 90px); /* sesuaikan supaya sejajar dengan label 'Pengarang :' */
                                        vertical-align:middle;
                                    " title="{{ $item->pengarang }}">
                                        {{ $item->pengarang }}
                                    </a>
                                </p>
                            ...
                            @if (Auth::user()->isAdmin == 0)
                                <div class="button-area">
                                    <button class="btn-sm btn-info px-2"> <a href="/buku/{{ $item->id }}"
                                    style="text-decoration: none; color:white;">Detail</a></button>
                                    <button class="btn-sm btn-danger px-4"><a href="/peminjaman/create"
